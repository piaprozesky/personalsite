  ...
  return (
    <div className="aboutview">
      ...
      <p>
        ...
        authorisation and adapting the database to make it appropriate for this
        feature.
        <br />
        <br />
        The final project was the group project. Together we created an app that
        helps big groups plan trips together. I focused on the chat and a voting
        system that operated within the chat, editing profile information, as
        well as the overall functionality and styling of the app.
        <br />
        <br />
        I’m looking to work in a team where I can contribute to the mission and
        learn from other members as I grow into a full stack developer.
      </p>
    </div>
  );
}
