    ...
    <div id="projects">
      <div className="projectsview">
        ...
        <div className="project">
          ...
          <a className="text" href="https://www.johnrecoverycoaching.com">
            https://www.johnrecoverycoaching.com
          </a>
          <p className="text">Technologies Used: Wix</p>
        </div>

        <div className="project">
          <h2>Group Trip Planning App - Group Project</h2>
          <p className="text">
            Full stack app that helps big groups plan trips together, with a
            focus on families. Implemented features: group chat function:
            enabling communication for group members a voting system to help
            with description making displaying profile information with the
            option to edit this information.
          </p>
          <div className="text">
        ...
        <div className="project">
          ...
          <p className="text">
            ...
            role-based data visualisation using technologies like: JSON Web
            Token (generating tokens), bcrypt (password hashing).
          </p>
          <div className="text">
        ...
        <div className="project">
          ...
          <p className="text">
            ...
            programming. Implemented features: Admin dashboard to enable admins
            to post internship opportunities and accept applications. Open
            applications listing page for students to browse through and apply
            for internships.
          </p>
          <div className="text">
